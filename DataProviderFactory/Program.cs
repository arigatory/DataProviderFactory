...
using (DbConnection connection = factory.CreateConnection())
{
    ...
    command.CommandText =
    "Select i.Id, m.Name, i.PetName From Inventory i inner join Makes m on m.Id = i.MakeId ";
    ...
    using (DbDataReader dataReader = command.ExecuteReader())
    {
        ...
        {
            Console.WriteLine($"-> Car #{dataReader["Id"]} is a {dataReader["Name"]} but I call it {dataReader["PetName"]}.");
        }
    }
}
Console.ReadLine();
